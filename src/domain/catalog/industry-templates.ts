...
export const INDUSTRY_TEMPLATES: IndustryTemplate[] = [
  {
    ...
    recommendedIntegrations: ['n8n', 'whatsapp', 'google_calendar', 'gmail'],
    defaultChannels: ['whatsapp', 'telefono', 'web', 'google_business'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    recommendedIntegrations: ['n8n', 'whatsapp', 'google_calendar'],
    defaultChannels: ['whatsapp', 'instagram', 'telefono', 'google_business'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    coreAgents: ['recepcionista', 'seguimiento'],
    recommendedIntegrations: ['n8n', 'whatsapp', 'google_calendar', 'gmail'],
    defaultChannels: ['whatsapp', 'web', 'email', 'telefono'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    coreAgents: ['recepcionista', 'comercial', 'seguimiento'],
    recommendedIntegrations: ['n8n', 'whatsapp', 'google_calendar', 'gmail'],
    defaultChannels: ['whatsapp', 'web', 'telefono', 'email'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    coreAgents: ['recepcionista', 'comercial', 'seguimiento'],
    recommendedIntegrations: ['n8n', 'whatsapp', 'google_calendar', 'stripe'],
    defaultChannels: ['whatsapp', 'instagram', 'web', 'telefono'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    recommendedIntegrations: ['n8n', 'whatsapp', 'google_calendar', 'gmail'],
    defaultChannels: ['telefono', 'email', 'web', 'whatsapp'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    recommendedIntegrations: ['n8n', 'whatsapp', 'stripe', 'gmail', 'instagram'],
    defaultChannels: ['web', 'instagram', 'email', 'whatsapp'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    coreAgents: ['recepcionista', 'comercial', 'seguimiento'],
    recommendedIntegrations: ['n8n', 'gmail', 'google_calendar', 'whatsapp'],
    defaultChannels: ['email', 'web', 'telefono', 'whatsapp'],
    knowledgeSeeds: [
  ...
  },
  {
    ...
    coreAgents: ['recepcionista', 'comercial'],
    recommendedIntegrations: ['n8n', 'whatsapp', 'gmail'],
    defaultChannels: ['whatsapp', 'email', 'web'],
    knowledgeSeeds: [
